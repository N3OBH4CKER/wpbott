...
Membuat gambar dari teks`);
        ...
        case "openai":
          try {
            ...
            const fill = fs.openSync("con/" +puss+".txt", 'a');  
            const jsonObj = JSON.parse(convo);
            const botn = " ";
            let redo = fs.readFileSync("con/" + puss + ".txt");
            ...
            fs.appendFile("con/convo.txt", newl, function (err) {
              if (err) throw err;
            });
            fs.appendFile("con/" + puss + ".txt", space, function (err) {
               fs.appendFile("con/" + puss + ".txt", newl, function (err) {
                  fs.appendFile("con/" + puss + ".txt", space, function (err) {
                     fs.appendFile("con/" + puss + ".txt", jsonObj, function (err) {
                        fs.appendFile("con/" + puss + ".txt",newl, function (err) {
                          fs.appendFile("con/" + puss + ".txt", newl, function (err) {
                            fs.appendFile("con/" + puss + ".txt", rply, function (err) {
                              fs.appendFile("con/" + puss + ".txt", newl, function (err) {
              if (err) throw err;
            });
              if (err) throw err;
